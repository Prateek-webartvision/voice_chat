...
class PostFriendsCommentCard extends StatefulWidget {
  const PostFriendsCommentCard({Key? key, required this.postId}) : super(key: key);
  final int postId;

  @override
  State<PostFriendsCommentCard> createState() => _PostFriendsCommentCardState();
}

class _PostFriendsCommentCardState extends State<PostFriendsCommentCard> {
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: GetBuilder<PostFriendsController>(builder: (postController) {
              // get post data
              PostModel post = postController.allFriendsPostList.where((element) {
                ...
                itemBuilder: (context, index) {
                  ...
                  return commentCard(
                    ...
                    onDelete: (String commentId) {
                      // print(postController.removeCommentPost(postId: post.id, commentId: commentId));
                      PostRepository.instance.removeFriendsPostComment(commentId: commentId, postId: post.id);
                    },
                  );
                },
              );

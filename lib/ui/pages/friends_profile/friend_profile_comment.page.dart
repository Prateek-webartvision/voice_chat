...
class FriendProfileCommentCard extends StatefulWidget {
  const FriendProfileCommentCard({Key? key, required this.postId}) : super(key: key);
  final int postId;

  @override
  State<FriendProfileCommentCard> createState() => _FriendProfileCommentCardState();
}

class _FriendProfileCommentCardState extends State<FriendProfileCommentCard> {
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: GetBuilder<FriendProfileController>(builder: (postController) {
              // get post data
              FriendProfilePostModel post = postController.friendProfilePostList!.where((element) {
                ...
                itemBuilder: (context, index) {
                  ...
                  return commentCard(
                    ...
                    onDelete: (String commentId) {
                      FriendProfileRepository.removeComment(commentId: commentId, postId: post.id);
                    },
                  );
                },
              );
              ...
              IconButton(
                  onPressed: () async {
                    ...
                    if (commentMessageController.text.isEmpty) {
                      ...
                      await FriendProfileRepository.addPostComment(
